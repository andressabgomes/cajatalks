...
-- Insert default admin user (you'll need to replace this with actual user ID after creating the user in Supabase Auth)
-- This is just a placeholder - you should create the admin user through the Supabase Auth UI first
-- INSERT INTO public.users (id, email, full_name, role) 
-- VALUES ('00000000-0000-0000-0000-000000000000', 'admin@cajatalks.com', 'Administrador', 'admin');
