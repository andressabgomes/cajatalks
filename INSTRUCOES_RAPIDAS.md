# 🚀 INSTRUÇÕES RÁPIDAS - EXECUTAR SCHEMA SQL

## ⚡ EXECUTE AGORA (2 minutos)

### 1. Acesse o Supabase
**Link**: https://supabase.com/dashboard/project/wsphcdeljnboalxsvuun

### 2. Execute o SQL
1. **Clique em "SQL Editor"** (menu lateral)
2. **Clique em "New Query"**
3. **Copie TODO o SQL abaixo** (Ctrl+A, Ctrl+C)
4. **Cole no editor** (Ctrl+V)
5. **Clique em "Run"** (botão azul)
6. **Aguarde completar** (alguns segundos)
...
O projeto estará 100% funcional com:
...
3. **Copie TODO o SQL** sem cortes
4. **Aguarde** a execução completar
5. **Execute** `node scripts/test-connection.js` para verificar
